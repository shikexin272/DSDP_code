...
# Window-based Self-Attention block
class WSA(nn.Module):
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        #a parameter table for relative position bias
...
class NSAB(nn.Module):
    def __init__(self, dim, input_resolution, num_heads, window_size,
                 mlp_ratio=3., qkv_bias=True, qk_scale=None, drop=0., attn_drop=0.,act_layer=nn.Softplus):
    ...
    def forward(self, x):
        ...
        x_windows = x_windows.view(-1, self.window_size * self.window_size, C)  # [nW*B, win*win, C]
        # attention operator
